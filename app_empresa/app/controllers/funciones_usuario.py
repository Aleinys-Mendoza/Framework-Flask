...
import re
#Para encriptar contraseña generate_passworf_hash
    ...
    if(respuestaValidar):
        ...
        try:
            with connectionBD() as conexion_MySQLdb:
             ...
             print(f"Error en el Insert usuario: {e}")
             return[]
        ...
        try:
            with connectionBD() as conexion_MySQLdb:
                with conexion_MySQLdb.cursor(dictionary=True) as cursor:
                        querySQL= "Select * FROM usuario WHERE email = %s" 
                        ...
                        if userBD is not None:
                            ...
                            #La cuenta no existe y los datos del formulario son validos, puedo realizar el Insert
                            return True
        except Exception as e:
